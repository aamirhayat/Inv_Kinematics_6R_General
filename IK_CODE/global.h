...
/* when change the size of the maxiaml matrix, the constants defined
in eigen1.c also need to be changed to do matrix multiplication */
...
*/
    extern coordinate NEM2[12][12],NEM21[12][12];
    extern coordinate NEM1[12][12], NIEM1[12][12];
    extern coordinate NEM0[12][12], NIEM0[12][12];
    extern coordinate work[500];

/*
 Used for Condition Number Evaluations in LAPACK routines .
*/
   extern coordinate vl[24][24],VR[24][24],rconde[24],rcondv[24],scale[28],abnrm;
/*
   EIG is the final matrix whose eigenvalues we compute to solve for x3.
*/
    extern coordinate EIG[24][24], EIG1[24][24],EIGcopy[24][24],EIG1copy[24][24];
    extern coordinate TT[24][24], TT1[24][24];
    extern coordinate SVD1[12][12],SVD[12][12];
/*
    int  fGeneralized;
...
*/
    ...
    extern coordinate Ralpha, Rbeta, Rgamma, Rdelta;
    extern coordinate Icond; /* the condition number in the computations. */
