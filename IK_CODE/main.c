...

{
    ...
    printf("\n\n ********SOLUTIONS FOR THE INVERSE KINEMATICS PROBLEM IN z_output.dat********\n");
    ...
    printf(" TIME in calculating the generalized inverse kinematics (16 solutions). \n");
    printf(" start time  = %d\n", tt1);
